...
app_repo_storage="https://github.com/${app_repo_author}/proteus-apt-repo.git"
...
app_repo_url="https://github.com/${app_repo_author}/${app_repo_script}"
app_repo_mnfst="https://raw.githubusercontent.com/${app_repo_author}/${app_repo_script}/${app_repo_branch}/manifest.json"
app_repo_script="https://raw.githubusercontent.com/${app_repo_author}/${app_repo_script}/BRANCH/setup.sh"
...
EOF
    ...
    #   tree -a --dirsfirst -I '.git' -H https://github.com/${app_repo_author}/${app_repo_script}/src/branch/$app_repo_branch/ -o $app_dir/.data/tree.html
