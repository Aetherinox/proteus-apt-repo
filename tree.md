# Repo Tree
Last generated on `10.26.2023 09:19:41`
...
│   ├── proteus-git-26102023.log
│   └── proteus-git-26102023.log.pipe
├── node_modules
│   └── .yarn-integrity
├── pool
│   └── main
...
│       │   │   ├── mysql-client_8.0.34-0ubuntu0.23.04.1_all.deb
│       │   │   ├── mysql-server_8.0.34-0ubuntu0.22.04.1_all.deb
│       │   │   └── mysql-server_8.0.34-0ubuntu0.23.04.1_all.deb
│       │   └── mysql-defaults
...
│       │   ├── php-grpc
│       │   │   └── php-grpc_1.51.1+really.1.50.2-1+ubuntu22.04.1+deb.sury.org+1_amd64.deb
│       │   ├── php-igbinary
│       │   │   ├── php-igbinary_3.2.13-1ubuntu1_amd64.deb
│       │   │   ├── php-igbinary_3.2.13-1ubuntu1_arm64.deb
